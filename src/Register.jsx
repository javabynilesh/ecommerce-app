...
let Register = () => {
    ...
    //dirty state to indicate that whether field is touch or not if touch will set true
    ...
    let validate = () =>{
        ...
        if(!state.receiveNewsLetters){
            errorsData.receiveNewsLetters.push("Please select receive News Letters");
        }
    ...
    let isValid = () => {
        let valid = true;
        //write isvalid logic
        //readind all control fields from 'errors' state
    ...
    let onRegisterClick = async () => {
         //set all controls/fields as dirty
         let dirtyData = dirty;
                    ...
                    <div className="card-body border-bottom">
                        ...
                        <div className="form-group form-row">
                            ...
                            <div className="col-lg-8">
                                ...
                                <div className="text-danger">
                                {dirty["receiveNewsLetters"] && errors["receiveNewsLetters"][0]
